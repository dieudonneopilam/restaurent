<div class="grid w-10/12 mx-auto bg-white shadow-lg rounded-2xl md:w-3/5 md:grid-cols-2 h-3/4">
    <div class="hidden w-full p-10 md:block h-96">
        <img class="object-fill w-full h-full rounded-tl-2xl rounded-bl-2xl" src="{{ asset('img/user.jpg') }}" alt="" srcset="">
    </div>
    ...
    <div class="flex items-center justify-start ">
        ...
        <form wire:submit.prevent='submit' class="flex flex-col items-start justify-between">
            <div class="w-full m-3">
                <input wire:model='nom' placeholder='enter le nom' class="w-full h-10 p-1 pl-2 border rounded"  type="text">
            </div>
            ...
            <div class="w-full m-3">
                <input wire:model='prenom' placeholder='enter le prenom' class="w-full h-10 p-1 pl-2 border rounded"  type="text">
            </div>
            <div class='ml-3 text-red-600'>
                @error('prenom')
                    {{ $message }}
            ...
            <div class="w-full m-3">
                <input wire:model='mail' placeholder='enter le mail' class="w-full h-10 p-1 pl-2 border rounded" type="email">
            </div>
            <div class='ml-3 text-red-600'>
                @error('mail')
                    {{ $message }}
            ...
            <div class="w-full m-3">
                <input wire:model='password' placeholder='enter le password' class="w-full h-10 p-1 pl-2 border rounded"  type="password">
            </div>
            <div class='ml-3 text-red-600'>
                @error('password')
                    {{ $message }}
            ...
            <div class="w-full m-3">
                <input wire:model='password_confirmation' placeholder='confirm votre password' class="w-full h-10 p-1 pl-2 border rounded" type="password">
            </div>
            <div class='ml-3 text-red-600'>
            ...
            <div class="w-full m-3">
                <input class="w-full h-10 p-1 pl-2 border rounded" type="file" wire:model='file'>
            </div>
            <div class='ml-3 text-red-600'>
                @error('file')
                    {{ $message }}
