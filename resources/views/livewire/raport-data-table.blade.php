                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="px-6 py-3 text-left whitespace-nowrap">
                                <div class="flex items-center">
                                    <span class="font-medium">{{ date('Y-m-d', strtotime($rapport->date_rapport)) }}</span>
                                </div>
                            </td>
                            <td class="px-6 py-3 text-left whitespace-nowrap">
                            ...
                            <td class="px-6 py-3 text-left whitespace-nowrap">
                                <div class="flex items-center text-green-500">
                                    <span class="font-medium">{{ $rapport->vente_jour + $rapport->dette_jour - $rapport->achat_jour - $rapport->depense_jour }} FC</span>
                                    <span class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-all" viewBox="0 0 16 16">
                                            <path d="M8.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L2.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093L8.95 4.992a.252.252 0 0 1 .02-.022zm-.92 5.14.92.92a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 1 0-1.091-1.028L9.477 9.417l-.485-.486-.943 1.179z" />
                                        </svg>
                                ...
                                <div class="flex items-center text-red-500">
                                    <span class="font-medium">{{ $rapport->vente_non_payer + $rapport->dette_non_payer  }}FC</span>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-exclamation" viewBox="0 0 16 16">
                                            <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0L7.1 4.995z" />
                                        </svg>
        ...
        <div class="w-full m-5 lg:w-5/6">
            <div class="flex flex-wrap-reverse items-center justify-between mx-1">
                ...
                <div class="w-full h-10 sm:w-2/3">
                    ...
                    <input x-model="dateReport" x-mask="9999-99-99" class="w-4/5 h-full px-5 border rounded sm:w-1/2" wire:model.debounce.500ms="searchRapport" placeholder="AAAA/MM/JR">
                ...
                <table class="w-full table-auto min-w-max">
                    ...
                    <tbody class="text-sm font-light text-gray-600">
                        ...
                        <tr x-show="dateReport.length >= 10" class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="px-6 py-3 text-left whitespace-nowrap">
                                <div class="flex items-center text-green-500">
                                    <span class="font-medium">{{ $montant_vente_valide + $montant_dette_valide - $montant_depenses - $montant_achat}}FC</span>
                                    <span class="">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-check-all" viewBox="0 0 16 16">
                                            <path d="M8.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L2.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093L8.95 4.992a.252.252 0 0 1 .02-.022zm-.92 5.14.92.92a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 1 0-1.091-1.028L9.477 9.417l-.485-.486-.943 1.179z" />
                                        </svg>
                                ...
                                <div class="flex items-center text-red-500">
                                    <span class="font-medium">{{ $montant_vente_invalide + $montant_dette_invalide}}FC</span>
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-exclamation" viewBox="0 0 16 16">
                                            <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.553.553 0 0 1-1.1 0L7.1 4.995z" />
                                        </svg>
                            ...
                            <td class="inline-block px-6 py-3 text-left">
                                <div class="flex justify-center item-center">
                                    ...
                                    @if (!$is_report->count())
                                        @if ($montant_vente_valide)
                                        <div x-show="dateReport.length >= 10" class="px-2 py-1 mr-5 text-white transform bg-green-500 rounded-full w-14 hover:scale-110 ">
                                            <a wire:click="valider({{ $searchRapport }})" href="#">valider</a>
                                        </div>
                                        @endif
                                    @endif
